...
\begin{frame}{Введение}
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.7\textwidth]{revil-logo.jpg}
    \end{figure}
    \begin{itemize}
...
\begin{frame}{Command and Scripting Interpreter: Visual Basic (T1059.005)}
    \begin{figure}[h!]
        \centering
...
\begin{frame}{Process Injection (T1055)}
    \begin{figure}[h!]
        \centering
...
\begin{frame}{Прочие тактики и техники}
    \begin{itemize}
        \item Access Token Manipulation: Token Impersonation/Theft (T1134.001)
        \item Access Token Manipulation: Create Process with Token (T1134.002)
